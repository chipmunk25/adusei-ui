...
export default function DataTablePaginate<TData>({
  tableParams,
  pagination,
  table,
          ...
          <nav className="flex flex-grow justify-center">
            <ul className="flex items-center">
              <Pagination.PageButton
                activeClassName="relative block rounded-lg bg-secondary-500 text-primary-500 px-3 py-1.5 text-sm font-medium  transition-all duration-300"
                inactiveClassName=""
