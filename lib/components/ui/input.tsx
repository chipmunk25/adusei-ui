    ...
    return (
      <div className="relative w-full">
        ...
        <input
          type={type}
          className={cn(
            "flex h-10 w-full rounded-md border border-neutral-400 bg-white px-3 py-2 text-sm ring-offset-zinc-900 transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-300 placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-zinc-900 disabled:cursor-not-allowed disabled:opacity-50",
            prefix && "pl-8",
            suffix && "pr-8",
            // !password && "uppercase",
            className
