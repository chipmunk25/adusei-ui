...
export const RichTextEditor = ({
  ...
  return (
    <div className="flex flex-col justify-stretch min-h-96">
      <div className="relative flex items-center h-8 px-2 pt-2 -mb-1 align-middle transition-colors bg-white border border-b-0 cursor-pointer shadow-shadow2a rounded-t-md ">
