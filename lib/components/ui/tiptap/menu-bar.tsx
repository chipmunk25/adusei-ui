...
const MenuBar = ({ editor }: { editor: Editor | null }) => {
  ...
  return (
    <div className="flex gap-2">
      ...
      <ToolTipMenuItem message="Text Color">
        <Popover>
          <PopoverTrigger>
            <Button
              size={"icon"}
              className={cn("text-text hover:cursor-pointer w-4 h-4", {
      ...
      >
        <SelectTrigger className="w-[100px] h-4 bg-white border-0 focus:ring-0 focus:ring-offset-transparent focus:ring-offset-0 rounded-none ring-transparent focus:ring-transparent focus:border-0 focus:outline-none">
