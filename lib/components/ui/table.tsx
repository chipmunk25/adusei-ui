...
>(({ className, normalTable, ...props }, ref) => (
  <div
    ...
    style={{
      height: normalTable ? "" : "calc(100vh - 220px)",
    }}
  >
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-0 transition-colors hover:bg-neutral-50 data-[state=selected]:bg-yellow-200",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "text-muted-foreground sticky top-0 h-12 bg-yellow-500 px-6 py-4 text-left align-middle font-medium text-primary-500 hover:bg-yellow-500 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
